...
function InvisibleStructure() {
    return (
        <>
          <Invisible position={[.7, 1.4, 6.5]} type="tunnel_wall" rotation={[0 , 0, 0]}  />
          <Invisible position={[2.1, 1.4, 6.5]} type="tunnel_wall" rotation={[0 , 0, 0]}  />
          <Invisible position={[0, 1.2, 6.5]} type="tunnel" rotation={[Math.PI / 180 * 118 ,0,0]}  />
